...
def login_request(request):
    ...
    if request.method == "POST":
        ...
        if user is not None:
            ...
            return render(request, 'djangoapp/index.hmtl', context)
    else:
...
def get_dealerships(request):
    ...
    if request.method == "GET":
        st = ""
        url = "https://5640258b.us-south.apigw.appdomain.cloud/capstone/dealerships"
...
def get_dealer_details(request, dealer_id):
    context={}
    if request.method == "GET":
        url = "https://5640258b.us-south.apigw.appdomain.cloud/capstone/reviews"
